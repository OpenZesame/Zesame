...
//        XCTAssertEqual(GasPrice.maxMagnitude, GasPrice.maxMagnitudeDefault)
//        let newMaxMagnitude: GasPrice.Magnitude = (GasPrice.min.inLi + 1.li).qa
...
//            switch error {
//            case .tooLarge(let max):
//                XCTAssertEqual(max.qa, newMaxMagnitude)
//            default: XCTFail()
//            }
//        } catch {
//            return XCTFail()
...
//        XCTAssertEqual(GasPrice.maxMagnitude, GasPrice.maxMagnitudeDefault)
//        let newMaxMagnitude: GasPrice.Magnitude = Zil(1337).qa
//        GasPrice.maxMagnitude = newMaxMagnitude
