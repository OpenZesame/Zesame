...
//        let keystore
//        self.init(keystore: <#T##Keystore#>, address: <#T##Address#>)
//    }
//}
...
//private let wallet = Wallet(privateKeyHex: privateKey)  //Wallet(privateKeyHex: privateKey, balance: 100000, nonce: 3)!
