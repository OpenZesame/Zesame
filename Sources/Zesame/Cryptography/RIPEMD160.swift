...
private struct Context {
    ...
    private mutating func compress(_ block: [UInt8]) {
        ...
        func f0(_ x: UInt32, _ y: UInt32, _ z: UInt32) -> UInt32 { x ^ y ^ z }
        func f1(_ x: UInt32, _ y: UInt32, _ z: UInt32) -> UInt32 { (x & y) | (~x & z) }
        func f2(_ x: UInt32, _ y: UInt32, _ z: UInt32) -> UInt32 { (x | ~y) ^ z }
        func f3(_ x: UInt32, _ y: UInt32, _ z: UInt32) -> UInt32 { (x & z) | (y & ~z) }
        func f4(_ x: UInt32, _ y: UInt32, _ z: UInt32) -> UInt32 { x ^ (y | ~z) }
        ...
        let kl: [UInt32] = Array(repeating: 0x00000000, count: 16) +
                            Array(repeating: 0x5A827999, count: 16) +
                            Array(repeating: 0x6ED9EBA1, count: 16) +
                            Array(repeating: 0x8F1BBCDC, count: 16) +
                            Array(repeating: 0xA953FD4E, count: 16)
        let kr: [UInt32] = Array(repeating: 0x50A28BE6, count: 16) +
                            Array(repeating: 0x5C4DD124, count: 16) +
                            Array(repeating: 0x6D703EF3, count: 16) +
                            Array(repeating: 0x7A6D76E9, count: 16) +
                            Array(repeating: 0x00000000, count: 16)
