...
public struct ByteArray: Sendable {
...
public struct ProtoTransactionCoreInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasToaddr: Bool {self._toaddr != nil}
  ...
  public var senderpubkey: ByteArray {
    get {_senderpubkey ?? ByteArray()}
    set {_senderpubkey = newValue}
  }
  /// Returns true if `senderpubkey` has been explicitly set.
  public var hasSenderpubkey: Bool {self._senderpubkey != nil}
  ...
  public var hasGaslimit: Bool {self._gaslimit != nil}
...
public struct ProtoTransaction: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasTranid: Bool {self._tranid != nil}
  ...
  public var info: ProtoTransactionCoreInfo {
    get {_info ?? ProtoTransactionCoreInfo()}
    set {_info = newValue}
  }
...
public struct ProtoTransactionReceipt: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasCumgas: Bool {self._cumgas != nil}
...
public struct ProtoTransactionWithReceipt: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var transaction: ProtoTransaction {
    get {_transaction ?? ProtoTransaction()}
  ...
  public var receipt: ProtoTransactionReceipt {
    get {_receipt ?? ProtoTransactionReceipt()}
    set {_receipt = newValue}
  }
  /// Returns true if `receipt` has been explicitly set.
  public var hasReceipt: Bool {self._receipt != nil}
...
extension ProtoTransactionCoreInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}version\0\u{1}nonce\0\u{1}toaddr\0\u{1}senderpubkey\0\u{1}amount\0\u{1}gasprice\0\u{1}gaslimit\0\u{1}code\0\u{1}data\0")
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._toaddr {
      try visitor.visitSingularBytesField(value: v, fieldNumber: 3)
    } }()
    try { if let v = self._senderpubkey {
...
extension ProtoTransaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}tranid\0\u{1}info\0\u{1}signature\0")
...
extension ProtoTransactionReceipt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}receipt\0\u{1}cumgas\0")
...
extension ProtoTransactionWithReceipt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}transaction\0\u{1}receipt\0")
